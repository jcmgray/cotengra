...
from .tree import td_str_to_tree_decomposition, td_to_eo
...
class FlowCutterOptimizer(PathOptimizer):
    ...
    def __init__(self, max_time=10, seed=None,
        ...
        with tempfile.NamedTemporaryFile(suffix='.gr') as file:
            ...
            while True:
                try:
                    ...
                    max_time *= 1.5
                    warnings.warn("FlowCutter produced no input, automatically"
